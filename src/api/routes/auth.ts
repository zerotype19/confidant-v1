...
// Get current user
authRouter.get("/me", async (c: Context<Env>) => {
  const db = c.env.DB
...
authRouter.post("/signup", zValidator("json", signUpSchema), async (c: Context<Env>) => {
...
authRouter.post("/signin", zValidator("json", signInSchema), async (c: Context<Env>) => {
...
// Google OAuth login
authRouter.get("/google", async (c: Context<Env>) => {
...
authRouter.get("/google/callback", async (c: Context<Env>) => {
...
// Sign out
authRouter.post("/signout", async (c: Context<Env>) => {
